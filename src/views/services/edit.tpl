...
<form action = "{{path('services_update')}}">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
        <input type="number" step="any" class="form-control" id="service_name" name="service_name" value="{{service.name}}" placeholder="Nombre del servicio" readonly>
    </div>
  </div>
    ...
    <div class="col-sm-10">
        <input type="number" step="any" class="form-control" id="service_price" name="service_price" value="{{service.price | number_format( 2 ) }}" placeholder="Precio con IVA">
    </div>
  </div>
    ...
    <div class="col-sm-10">
        <input type="text" class="form-control" id="service_base_price" name="service_base_price" value="{{service.base_price | number_format( 2 ) }}" placeholder="Precio sin IVA" readonly>
    </div>
  </div>
